...
<body>
    ...
    <main class="main">
        ...
        <div class="l-form">
            ...
            <div class="form">
                <img src="img/authentication3.svg" alt="" class="form__img">

                <div class="form__content">
                    <h1 class="form__title">Welcome</h1>

                    <div class="form__div form__div-one" id="resp">
                    ...
                    <div class="form__div form__div-one">
                        ...
                        <div class="form__div-input">
                            ...
                            <input type="text" class="form__input" id="email" name="email" placeholder="Email"
                                value="<?php echo (isset($_SESSION['email'])) ? $_SESSION['email'] : '';?>">
                            <!-- Response -->
                            <div id="ename_response" class="response"></div>
                        </div>
                    </div>
                    ...
                    <input type="submit" class="form__button" id="btnSignup" value="Signup" name="btnSignup">

                    <!-- Response -->
                    <div id="error_response" class="alertmsg"></div>
